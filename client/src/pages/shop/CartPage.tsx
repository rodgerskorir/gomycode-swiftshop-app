          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2">
              <ul className="divide-y divide-gray-200">
                {cart.map((item) => (
                  <li key={`${item._id}-${item.selectedSize}`} className="py-6 flex flex-col sm:flex-row gap-4">
                    <div className="w-full sm:w-24 h-24 border rounded-md overflow-hidden flex-shrink-0">
                      <img
                        src={item.image[0]}
                        alt={item.name}
                    ...
                    <div className="flex-1 flex flex-col">
                      ...
                      <div className="flex-1 flex flex-col sm:flex-row items-start sm:items-center justify-between mt-4 gap-3">
                        {/* Quantity Controls */}
